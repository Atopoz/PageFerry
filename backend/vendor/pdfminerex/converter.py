...
if TYPE_CHECKING:
    from .pdfinterp import TextBlockRecorder
...
class PDFLayoutAnalyzer(PDFTextDevice):
    ...
    def paint_path(
        ...
        if shape[:1] != "m":
            ...
            # or re to begin a new subpath." Since .six already
    ...
    def render_char(
        ...
        text_block: Optional["TextBlockRecorder"] = None,
    ) -> float:
        try:
...
class HOCRConverter(PDFConverter[AnyIO]):
    ...
    def write_header(self) -> None:
        ...
        self.write(
            "<meta name='ocr-system' content='.six HOCR Converter' />\n",
        )
        self.write(
